...
This repository evaluates reliability, calibration, and robustness of LLMs (we used `meta-llama/Llama-3.1-8B-Instruct`) across temperature and perturbation settings.  
